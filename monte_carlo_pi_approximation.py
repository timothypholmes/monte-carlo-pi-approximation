...
title = ax2.set_title('', fontsize=20)
...
def animate(i):
    ...
    #title.set_text("Pi approximation= %f" % (4*points_inside /n_points))
animate = plt.matplotlib.animation.FuncAnimation(fig, animate, init_func=init, frames=n_points, interval=time, repeat=False)
